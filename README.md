...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 46e4d73a-85a3-45d1-9e90-8bbf40fdb01d
```

> `46e4d73a-85a3-45d1-9e90-8bbf40fdb01d` is the password of the certificate, you can change it to any password you want.
